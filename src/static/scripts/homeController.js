...
const viewBag = {
    ...
    info: `Join today and gift your family and 
    loved ones with an unique experience`,
};
            ...
            .then(() => {
                dataService.getFiveVideos()
                    .then((data) => htmlHelper
                        .getHtml('home-videos', { model: { videos: data } }))
                    .then((html) => htmlHelper
                        .insert('#home-videos', html));
            });
    },
};
